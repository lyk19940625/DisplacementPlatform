  ...
  <head>
	...
	$(function(){
		...
		$('#jia').click(function (){
		 ...
		 var x=parseInt($('input[name=num]').val());
		$('#jian').click(function (){
	...
	function edit2(){
        ...
        c.setAttribute("href","goods/qury_order?gid="+gid.value+"&count="+num.value); 
...
<body>
	...
	<div class="Dbox">
		...
		<div class="box">
			...
			<div class="cent">
				...
				<div class="clear" style="margin-top:20px;">
					...
					<div class="num_box">
						<input type="text" name="num" id="num" value="${goods.count}" style="width:40px;height:32px;text-align:center;float:left" readonly>
						<input type="hidden"  value="${goods.gid}" id="gid"/>
						<div class="rg">
						<button  id='jian' style= "height:32px;width:32px ">-</button>
							
						</div>
					</div>
				</div>
				<div class="clear" style="margin-top:20px;">
					<a href="" id="c" onclick="edit2()"><img src="images/mai.jpg" alt=""></a>
		...
		<div class="bottom">
			...
			<div class="btm">
				 <form action="transaction/bargain" name="bargain" method="get">
					           ...
					           <td><textarea class="comments" rows="15" cols="17" name="Content"> </textarea></td>
					            ...
					            <td align="center"> <button type="submit">提交</button></td>
					             <td><input type="hidden" name="Gid" value="${goods.gid}"/></td>
