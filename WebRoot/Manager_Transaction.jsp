			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						...
						<li class="active"><a href="manager/query_transaction">交易信息</a></li>
							 ...
							 <form action="manager_student" method="post"> 
					            ...
					            <tr>
					             <td><c:out value="${t.tid}"/></td>
					               <td><c:out value="${t.gid}"/></td>
					                 <td><c:out value="${t.inuid}"/></td>
					                   <td><c:out value="${t.outuid}"/></td>
					                  
					                      <td><c:out value="${t.count}"/></td>
					                        <td><c:out value="${t.deliver}"/></td>
					                        <td><c:out value="${t.evaluate}"/></td>
